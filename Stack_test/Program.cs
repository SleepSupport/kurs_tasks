...
namespace kurs_task_Students
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Stack<Student> testStack = new Stack<Student>() { };
            testStack.Push(new Student("Глеб", "Криткович"));
            testStack.Push(new Student("Вова", "Жуковский"));
            testStack.Push(new Student("Коля", "Лисовский"));
            testStack.Push(new Student("Никита", "Кухарев"));
